...
#scores <- cicero@assays$data$logGA[, keep]
#saveRDS(scores, '../data/score_activity_matrix_cd8tcells.rds')
scores <- read_rds('../data/score_activity_matrix_cd8tcells.rds')
#sam_ann <- data.frame(
#        UMAP1 = cicero$UMAP1,
#        UMAP2 = cicero$UMAP2,
...
#)
#saveRDS(sam_ann[keep, ], '../data/score_activity_matrix_annotations_cd8tcells.rds')
